...
export default function DownloadCard(props: Props) {
  return (
    <>
      <Card cover={<img alt="example" src={'http://ddr7.shahi.co.in/design_room/dist/services/kanban-service/upload-files/'+ props.data.fileName} style={{width:'50%',height:'60%'}} />}>
        <Meta
