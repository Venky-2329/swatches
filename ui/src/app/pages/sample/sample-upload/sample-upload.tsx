      ...
      >
        <Form form={form} layout="vertical" onFinish={onFinish}>
          <Row gutter={24}>
            ...
            {/* Render fields specific to each type */}
            {selectedType === 'Fabric' && (
              <>
                <Col
                  xs={{ span: 24 }}
                ...
                >
                  <Form.Item
                    ...
                    name={'qrCode'}
                    rules={[
                      { required: false, message: 'Please input QR CODE' },
                    ]}
                  >
                ...
                >
                  <Form.Item
                    ...
                    rules={[
                      {
                        required: false,
                        message: 'Please input Sourcing Name',
                      },
                    ]}
                  >
                    <Input placeholder="Enter Sourcing Name" />
                  </Form.Item>
                </Col>
                <Col
                  xs={{ span: 24 }}
                  ...
                  xl={{ span: 4 }}
                >
                  <Form.Item label="Fabric Po" name={'fabricPo'}>
                    <Input placeholder="Enter Fabric Po" />
                  </Form.Item>
                </Col>
                <Col
                  xs={{ span: 24 }}
                ...
                >
                  <Form.Item
                    ...
                    rules={[
                      {
                        required: false,
                        message: 'Please input Fabric Content',
                      },
                    ]}
                  >
                ...
                >
                  <Form.Item
                    label="Count & Contruction"
                    name={'countAndContruction'}
                    rules={[
                      {
                        required: false,
                        message: 'Please input Count & Contruction',
                      },
                    ]}
                  >
                    <Input placeholder="Enter Count & Contruction" />
                  </Form.Item>
                </Col>
                ...
                >
                  <Form.Item
                    ...
                    name={'quantity'}
                    rules={[
                      { required: false, message: 'Please input Quantity' },
                    ]}
                  >
                ...
                <Col
                  ...
                  xl={{ span: 4 }}
                >
                  <Form.Item label="AWB NO" name={'awbNo'}>
            ...
            {/* Render fields specific to each type */}
            {typesWithCommonFields.includes(form.getFieldValue('type')) && (
              <>
                <Col
                  xs={{ span: 24 }}
                  sm={{ span: 24 }}
                ...
                >
                  <Form.Item
                    ...
                    name={'itemNo'}
                    rules={[
                      { required: false, message: 'Please input Item No' },
                    ]}
                  >
                ...
                >
                  <Form.Item
                    ...
                    name={'fabricCount'}
                    rules={[
                      { required: false, message: 'Please input Fabric Count' },
                    ]}
                  >
