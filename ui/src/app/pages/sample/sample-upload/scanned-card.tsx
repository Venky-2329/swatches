...
export default function ScannedCard(){
  ...
  function getAll(val){
    ...
    return(
        <div >
        <Row gutter={24} >
           <Col xs={{ span: 24 }} sm={{ span: 24 }} md={{ span: 6 }} lg={{ span: 6 }} xl={{ span: 9}} >
           <Card hoverable style={{background:'#3f4648'}} cover={<img alt="example" src={'http://172.20.50.169/design_room/dist/services/kanban-service/upload-files/'+ data[0]?.fileName} />}>
        <Meta
          title={<div style={{ color: 'white' }}><b>Sample Digital Card</b></div>}
          description={
