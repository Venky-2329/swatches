...
export  const TrimSwatchGrid = () => {
    ...
    return(
        <>
        <Card title='Trim Swatch' extra={<span><Button type="primary" onClick={gotoGrid}>Create</Button>  </span>}  >
                ...
                <Col xs={24} sm={24} md={6} lg={4} xl={4}>
                    <Form.Item name={'trimSwatchNumber'} label={'Trim No'}>
                        <Select allowClear placeholder='Select Trim No'>
                            {data.map((item) => {
                                return(
                                    <Option key={item.trimSwatchId} value={item.trim_swatch_number}>
